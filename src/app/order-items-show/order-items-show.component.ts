...
@Component({
  selector: 'app-order-items-show',
  templateUrl: './order-items-show.component.html',

  styleUrls: ['./order-items-show.component.css',
  "../../../node_modules/bootstrap/dist/css/bootstrap.min.css",
]
})
export class OrderItemsShowComponent {
  ...
  ngOnInit(): void {
    ...
    this.orderItemService.retrieveOrderItems().subscribe(
      (allOrderItems: OrderItem[]) => {
        ...
        this.orderItems = allOrderItems.filter(orderItem => orderItem.user.id === iduser);
        this.orderItems = allOrderItems.filter(item => !item.paid);
